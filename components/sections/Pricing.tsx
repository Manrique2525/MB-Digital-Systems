...
const WEB_PLANS = [
  {
    ...
    icon: "🚀",
    name: "Landing Page",
    tagline: "Empieza a captar clientes",
    price: "4,999",
    desc: "Ideal para negocios que quieren lanzar su presencia digital rápido y bien.",
    features: [
      ...
      "Orientación de dominio y hosting",
    ],
  ...
  },
  {
    ...
    price: "9,999",
    desc: "Para empresas que necesitan una presencia profesional completa y administrable.",
    features: [
  ...
  },
  {
    ...
    price: "18,999",
    desc: "Tienda online completa con catálogo, carrito y pagos integrados.",
    features: [
